...
__global__ void compute_brute_force(particle_t* array, int nbr_particles, double step, int offset = 0);
__global__ void update_positions(particle_t* array, double step, int offset = 0);
